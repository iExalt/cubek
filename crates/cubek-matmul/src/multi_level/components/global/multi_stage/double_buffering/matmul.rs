    ...
    GW: GlobalWriterFamily,
{
    ...
    fn execute(
        ...
        let lhs_stage_a_tile =
            <LhsStageFor<MP, RC, LL> as crate::multi_level::components::stage::Stage<
                Stage<Lhs<MP>>,
            >>::as_stage_tile::<SP::Scope>(&lhs_stage_a);
        let lhs_stage_b_tile =
            <LhsStageFor<MP, RC, LL> as crate::multi_level::components::stage::Stage<
                Stage<Lhs<MP>>,
            >>::as_stage_tile::<SP::Scope>(&lhs_stage_b);
        let rhs_stage_a_tile =
            <RhsStageFor<MP, RC, RL> as crate::multi_level::components::stage::Stage<
                Stage<Rhs<MP>>,
            >>::as_stage_tile::<SP::Scope>(&rhs_stage_a);
        let rhs_stage_b_tile =
            <RhsStageFor<MP, RC, RL> as crate::multi_level::components::stage::Stage<
                Stage<Rhs<MP>>,
